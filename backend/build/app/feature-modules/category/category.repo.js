...
const updateOne = (filter, update) => __awaiter(void 0, void 0, void 0, function* () {
    return yield category_schema_1.CategoryModel.updateOne(filter, update);
});
const findOne = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    return category_schema_1.CategoryModel.findOne(Object.assign(Object.assign({}, filters), { isDeleted: false }));
});
